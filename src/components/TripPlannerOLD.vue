      ...
      <form>
        <div class="form-group mb-0">
          <input
            ...
            required
          >
          <label for="tpFrom" class="form-control-placeholder">From</label>
        </div>
              ...
              <div class="col">
                <div class="input-group mb-3">
                  ...
                  <div class="input-group-append border">
                    <IconSprite name="icon-sm-clock-gray" id="tpTime" class="icon-clock mt-2 mr-2"/>
                  </div>
                </div>
              </div>
              <div class="col">
          ...
          <div class="col-md-6">
            <div class="more-options" role="tablist">
              <b-card no-body class="border mb-1">
                <b-card-header header-tag="header" class="d-flex p-0" role="tab">
                  <b-button
                    href="#"
                  ...
                  >
                    More optioins
                    <IconSprite name="icon-sm-plus-blue" class="ml-auto"/>
                  </b-button>
                </b-card-header>
                  ...
                  <b-card-body class="border-top">
                    <b-card-text>
                      ...
                      <div class="custom-control custom-radio">
                        ...
                        >
                        <label class="custom-control-label" for="quarterMile">1/4 mile</label>
                      </div>
                      <div class="custom-control custom-radio">
                        <input
                          type="radio"
                      ...
                      <div class="custom-control custom-radio">
                        <input
                          ...
                          class="custom-control-input"
                        >
                        <label class="custom-control-label" for="tpAnyType">Any service type</label>
                      </div>
                      <div class="custom-control custom-radio">
                        <input
                          type="radio"
                          ...
                          class="custom-control-input"
                        >
                        <label class="custom-control-label" for="tpRailOnly">Rail only</label>
                      </div>
                      <div class="custom-control custom-radio">
                        <input
                          type="radio"
                          ...
                          class="custom-control-input"
                        >
                        <label class="custom-control-label" for="tpBusOnly">Bus only</label>
                      </div>
                      <div class="custom-control custom-radio">
                        <input
                          type="radio"
                          ...
                          class="custom-control-input"
                        >
                        <label class="custom-control-label" for="tpNoExpress">No express</label>
                      </div>
                      ...
                      <div class="custom-control custom-radio">
                        <input
                          ...
                          class="custom-control-input"
                        >
                        <label class="custom-control-label" for="tpFasterTrip">Faster trip</label>
                      </div>
                      <div class="custom-control custom-radio">
                        <input
                          type="radio"
                          ...
                          class="custom-control-input"
                        >
                        <label class="custom-control-label" for="tpFewerTransfers">Fewer transfers</label>
                      </div>
                      <div class="custom-control custom-radio">
                        <input
                          type="radio"
                          ...
                          class="custom-control-input"
                        >
                        <label class="custom-control-label" for="tpLessWalking">Less walking</label>
                      </div>

                      <hr>

                      <p class="m-0">
                        <IconSprite name="icon-sm-accessible-gray"></IconSprite>Accessible stops
                      </p>
                      <div class="custom-control custom-radio custom-control-inline">
                        <input
                          ...
                          class="custom-control-input"
                        >
                        <label class="custom-control-label" for="tpAccessibleStopYes">Yes</label>
                      </div>
                      <div class="custom-control custom-radio custom-control-inline">
                        <input
                          type="radio"
                          ...
                          class="custom-control-input"
                        >
                        <label class="custom-control-label" for="tpAccessibleStopNo">No</label>
                      </div>
                    </b-card-text>
                  </b-card-body>
                </b-collapse>
        ...
        <div class="row">
          <div class="col-md-4 offset-md-4">
            <b-btn type="Submit" variant="warning" block>Plan My Trip</b-btn>
          </div>
        </div>
      </form>
    </div>
