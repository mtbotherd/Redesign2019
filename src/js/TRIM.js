...
var BOM = (function ($, window, document, undefined) {
    ...
    var _TICKSTOP = 40; // after this many cycles pause the service
    ...
    var drawMarkerAtPoint = function (/*Point*/p) {
        ...
        require([
            ...
            "esri/symbols/SimpleLineSymbol"
                ...
                //var stopSymbol = new PictureMarkerSymbol('../img/svg/map-icons/pin-red.svg', 44, 50);
                stopSymbol.setOffset(0, 20);
