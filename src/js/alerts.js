var Alerts = (function($, window, document, undefined) {
    ...
    var buildAlerts = function(routeAbbr) {
        ...
        allAlerts.forEach(function(alert, index) {
            ...
            alert.informed_entity.forEach(function(entity, idx) {
                ...
                let current = $.grep(alertsByRoute, function(alert) {
                ...
                if (current === undefined) {
                    ...
                    switch (entity.route_id) {
                        case '901':
                            (sort = 0), (icon = 'blue-lrt');
                            break;
                        case '902':
                            (sort = 1), (icon = 'green-lrt');
                            break;
                        case '903':
                            (sort = 2), (icon = 'red-bus');
                            break;
                        case '921':
                            (sort = 3), (icon = 'gray-bus');
                            break;
                        case '923':
                        ...
                        case '992':
                            ...
                            break;
                        case '888':
                            (sort = 6), (icon = 'gray-outline-train');
                            break;
    ...
    var outputAlerts = function() {
        ...
        alertsByRoute.forEach(function(route, index) {
            ...
            btn.append(
                $('<span/>', { class: 'route-alert' }).text(route.route_label)
            );
            btn.append(
                $('<div/>', { class: 'ml-auto text-nowrap' })
                    .append(
                        $('<span/>', { class: 'number-alerts' }).text(
                            route.alert_index.length + ' Alert(s)'
                        )
                    )
                    .append(
                        $('<img/>', {
    ...
    var getAlertRouteList = function(idx) {
        ...
        allAlerts[idx].informed_entity.forEach(function(route, i) {
            ...
            routeList.push({
                ...
                route_label: rt.route_label.replace('Route', ''),
            });
        });
